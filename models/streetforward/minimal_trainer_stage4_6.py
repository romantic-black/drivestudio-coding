...
class MinimalStreetForwardStage4_6(MinimalStreetForwardStage4_5BaseNoRigidHead):
    ...
    def forward(self, batch: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "_source_frame_idx": int(source_frame_idx),
            "_route": route,
            "_feat_2d_bg": feat_2d_bg,
            "_feat_2d_distant": feat_2d_distant,
            "_feat_2d_rigid_S": feat_2d_rigid_S,
            "_acc_w_bg": acc_w_bg,
            "_acc_w_distant": acc_w_distant,
            "_acc_w_rigid_S": acc_w_rigid_S,
            "render_params": render_params_bg,
