"""
StreetForward 训练器 - 原始版本（仅供测试与回归比对）。

此文件为 models/trainers/streetforward.py 的重构前副本，用于：
- Golden Baseline 回归测试（重构前后比对）
- 回归不通过时的调试参考

正常导入请使用：from models.trainers.streetforward import StreetForwardTrainer
