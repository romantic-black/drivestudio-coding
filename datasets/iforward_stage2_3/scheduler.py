            ...
            self._last_info.update(
                {
                    ...
                    "stage3_2_raw_B": int(stage3_2_meta.get("raw_B", 0) or 0),
                    "stage3_2_raw_R": int(stage3_2_meta.get("raw_R", 0) or 0),
                    "stage3_2_B": int(stage3_2_meta.get("B", 0) or 0),
                    "stage3_2_R": int(stage3_2_meta.get("R", 0) or 0),
                    ...
                    "episode_distribution_rollout_count_repeat_refine": int(stage3_2_meta.get("episode_distribution_rollout_count_repeat_refine", 0) or 0),
                    "episode_distribution_rollout_count_shuffled_coverage": int(stage3_2_meta.get("episode_distribution_rollout_count_shuffled_coverage", 0) or 0),
                    "episode_distribution_rollout_count_high_block_repair": int(stage3_2_meta.get("episode_distribution_rollout_count_high_block_repair", 0) or 0),
                    "episode_distribution_k_count_repeat_refine": int(stage3_2_meta.get("episode_distribution_k_count_repeat_refine", 0) or 0),
                    "episode_distribution_k_count_shuffled_coverage": int(stage3_2_meta.get("episode_distribution_k_count_shuffled_coverage", 0) or 0),
                    "episode_distribution_k_count_high_block_repair": int(stage3_2_meta.get("episode_distribution_k_count_high_block_repair", 0) or 0),
                    "episode_distribution_weight_repeat_refine": float(stage3_2_meta.get("episode_distribution_weight_repeat_refine", 0.0) or 0.0),
                    "episode_distribution_weight_shuffled_coverage": float(stage3_2_meta.get("episode_distribution_weight_shuffled_coverage", 0.0) or 0.0),
                    "episode_distribution_weight_high_block_repair": float(stage3_2_meta.get("episode_distribution_weight_high_block_repair", 0.0) or 0.0),
