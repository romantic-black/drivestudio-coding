"""
Stage 5.4 multi-scene training entry for V4 dataset + V8 scheduler.
"""
...
def _select_stage5_4_trainer(config_path: str):
...
def main() -> None:
    default_config = "configs/minimal_streetforward_stage5_4_production_multi_scene_v8.yaml"
    if "--config_file" not in sys.argv:
        sys.argv.extend(
            [
                "--config_file",
    ...
    trainer_cls = _select_stage5_4_trainer(config_path)
    ...
    base.base.CKPT_PREFIX = "minimal_sf_stage5_4_multi_scene_v8"
