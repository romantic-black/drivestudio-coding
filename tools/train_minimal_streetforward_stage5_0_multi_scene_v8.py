"""
Stage 5.0 multi-scene training entry for V4 dataset + V8 scheduler.

Thin wrapper over Stage 4.3 multi-scene v8 entry:
...
def main() -> None:
    if "--config_file" not in sys.argv:
        sys.argv.extend(
            [
                "--config_file",
                "configs/minimal_streetforward_stage5_0_multi_scene_v8.yaml",
            ]
        )
    ...
    base.base.CKPT_PREFIX = "minimal_sf_stage5_0_multi_scene_v8"
    base.base.DEFAULT_CONFIG_FILE = "configs/minimal_streetforward_stage5_0_multi_scene_v8.yaml"
    base.main()
