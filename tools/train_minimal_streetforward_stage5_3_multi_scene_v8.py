...
def _select_stage5_3_trainer(config_path: str):
...
def main() -> None:
    default_config = "configs/minimal_streetforward_stage5_3_multi_scene_v8.yaml"
    if "--config_file" not in sys.argv:
        sys.argv.extend(
            [
                "--config_file",
    ...
    trainer_cls = _select_stage5_3_trainer(config_path)
