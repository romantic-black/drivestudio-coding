"""
Stage 5.2 multi-scene training entry for V4 dataset + V8 scheduler.
"""
...
def main() -> None:
    ...
    base.base.TRAINER_CLASS = MinimalStreetForwardStage5_2
    base.base.MinimalStreetForwardStage4_3 = MinimalStreetForwardStage5_2
    base.base.CKPT_PREFIX = "minimal_sf_stage5_2_multi_scene_v8"
    base.base.DEFAULT_CONFIG_FILE = "configs/minimal_streetforward_stage5_2_multi_scene_v8.yaml"
    base.main()
