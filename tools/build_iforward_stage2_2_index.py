...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build IForward Stage2_2 stream10 raw-frame index")
    ...
    index = build_stage2_2_index_from_dataset(dataset=dataset, cfg=cfg, output_dir=Path(args.output_dir))
    print(f"wrote Stage2_2 index to {args.output_dir}")
