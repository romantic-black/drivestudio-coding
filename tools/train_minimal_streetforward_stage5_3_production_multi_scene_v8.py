"""
Stage 5.3 production multi-scene training entry for V4 dataset + V8 scheduler.
"""
...
def main() -> None:
    ...
    base.base.TRAINER_CLASS = MinimalStreetForwardStage5_3_Production
    base.base.MinimalStreetForwardStage4_3 = MinimalStreetForwardStage5_3_Production
    base.base.CKPT_PREFIX = "minimal_sf_stage5_3_production_multi_scene_v8"
    base.base.DEFAULT_CONFIG_FILE = "configs/minimal_streetforward_stage5_3_production_multi_scene_v8.yaml"
    base.main()
