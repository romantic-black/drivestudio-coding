"""
Stage 5.6 one-segment overfit entry for V4 dataset + V8 frame-level scheduler.
"""
...
from tools.train_minimal_streetforward_stage5_6_one_segment_overfit_common import (
...
def main() -> None:
    default_config = "configs/minimal_streetforward_stage5_6_one_segment_overfit_v8.yaml"
    if "--config_file" not in sys.argv:
    ...
    base.build_train_scheduler_v8_from_cfg = build_train_scheduler_v8_one_segment_overfit_from_cfg
    base.resolve_fixed_scene_segment_v8 = resolve_fixed_scene_segment_v8_one_segment
    base.build_multi_scene_dataset_v4 = build_multi_scene_dataset_v4
    base.base.ALLOW_ONE_SEGMENT = True
    base.base.EPISODE_END_HOOK = OverfitSegmentEpisodeEvaluator()
    base.base.TRAINER_CLASS = trainer_cls
    base.base.MinimalStreetForwardStage4_3 = trainer_cls
    base.base.CKPT_PREFIX = "minimal_sf_stage5_6_one_segment_overfit_v8"
