"""
Stage 5.5 multi-scene training entry for V4 dataset + V8 scheduler.
"""
...
def main() -> None:
    default_config = "configs/minimal_streetforward_stage5_5_production_multi_scene_v8.yaml"
    if "--config_file" not in sys.argv:
        sys.argv.extend(
            [
                "--config_file",
    ...
    base.base.CKPT_PREFIX = "minimal_sf_stage5_5_multi_scene_v8"
