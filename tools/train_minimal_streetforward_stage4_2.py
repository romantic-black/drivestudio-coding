"""
Training script for Minimal StreetForward Stage 4.2.
"""
...
CKPT_PREFIX = "minimal_sf_stage4_2"


def main():
    parser = argparse.ArgumentParser(description="Train Minimal StreetForward Stage 4.2")
    parser.add_argument(
        "--config_file",
        type=str,
